...
export function ConfirmDialog({ open, title, children, confirmLabel, confirmDisabled = false, onConfirm, onClose }: PropsWithChildren<{ open: boolean; title: string; confirmLabel: string; confirmDisabled?: boolean; onConfirm(): void; onClose(): void }>) {
